...
async def post_usuario_novo(senha: str = Form(...), confsenha: str = Form(...),
    ...
    if senha == confsenha:
        ...
        response = redirecionar_com_mensagem("/novo", "As senhas não coincidem!")
...
async def get_area_restrita(request: Request, usuario: Usuario = Depends(obter_usuario_logado),):
    ...
    return templates.TemplateResponse("usuario/area_restrita.html", {"request": request, "usuario": usuario},)
